...
- Risk register with 12 risks, top-5 critical risks expanded, LGPD compliance plan, CIS Controls v8 mapping.
- Conventional Commits enforcement via commitlint and pre-commit hooks.
- README with quick start, documentation index and team contacts.

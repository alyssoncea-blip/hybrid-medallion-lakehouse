...
from snowflake.snowpark.functions import avg as sp_avg
...
from snowflake.snowpark.functions import round as sp_round
from snowflake.snowpark.types import IntegerType

from src.snowpark.udfs.feature_udfs import (
    PRICE_BUCKET_HIGH_MAX,
...
def engineer_features(df):
    ...
    df = df.with_column(
        "price_bucket",
        when(col("preco_unitario") < PRICE_BUCKET_LOW_MAX, "LOW")
        .when(col("preco_unitario") < PRICE_BUCKET_MEDIUM_MAX, "MEDIUM")
        .when(col("preco_unitario") < PRICE_BUCKET_HIGH_MAX, "HIGH")
        .otherwise("PREMIUM")
    )

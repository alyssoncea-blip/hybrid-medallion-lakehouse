...
variable "notification_users"          { type = list(string), default = ["data-governance@hybrid-lakehouse.local"] }
variable "data_classification_default" { type = string, default = "confidencial" }
